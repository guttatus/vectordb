...
HttpServer::HttpServer(const std::string &host, i32 port, VectorDB *vdb)
    : m_host(host), m_port(port), m_vector_db(vdb) {
...
void HttpServer::setErrorJsonResponse(httplib::Response &res, i32 error_code,
